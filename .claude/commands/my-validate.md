...
2. JSON validity of `.claude/settings.local.json`
3. No duplicate aliases in `bashrc*.sh`
4. `sync-claude.sh` produces expected files (`CLAUDE.md`, `commands/`, `settings.local.json`)
5. Re-running sync is idempotent
